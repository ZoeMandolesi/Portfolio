Project.create(
  title: "EasyClinic API",
  overview: "This meticulously crafted back-end application streamlines appointment scheduling for patients with a diverse network of healthcare professionals in the healthcare industry.",
...
Project.create(
  title: "PennyLane",
  overview: "PennyLane is a web application that simplifies personal finance management, allowing users to track expenses and budget effectively.",
